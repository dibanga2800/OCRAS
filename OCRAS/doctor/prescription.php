...
$sql=mysqli_query($con,"Update doctors set specialization='$docspecialization',doctorName='$docname',address='$docaddress',docFees='$docfees',contactno='$doccontactno',docEmail='$docemail' where id='$did'");
if($sql)
{
...
<html lang="en">
<head>
<title>Doctor | Patient Prescription Details</title>
<meta charset="utf-8" />
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Doctor | Patient Prescription Details</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Doctor</span>
...
<h5 class="panel-title">Patient Prescription info</h5>
</div>
