...
$sql=mysqli_query($con,"Update doctors set specialization='$docspecialization',doctorName='$docname',address='$docaddress',contactno='$doccontactno' where id='".$_SESSION['id']."'");
if($sql)
{
