...
<h4 class="text-center pull-left">Price</h4><br>
<form action="search.php" method="post">
<input type="hidden" name="cat" value="<?=$cat_id;?>">
<input type="hidden" name="price_sort" value="0"><br>
...
<?php endwhile; ?><br>
<input type="submit" value="search" class="btn btn-xs btn-primary pull-left">
</form>
