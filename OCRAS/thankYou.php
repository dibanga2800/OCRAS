...
//create the charge on stripe server. This will charge users card
try{
$charge = \Stripe\Charge::create(array(
    "amount" => $charge_amount, //amount in pence
    "currency" => CURRENCY,
    "source" => $token,
    ...
    ('$charge->id','$cart_id','$full_name','$email','$street','$street2','$city','$county','$post_code','$country','$sub_total','$tax','$grand_total','$description','$charge->object')");
...
<p>Your card has been succesfully charged <?=money($grand_total);?>. You have been emailed a receipt. Please
