...
$name=$_POST['fullname'];
$email=$_POST['email'];
$query=mysqli_query($con,"select id from  receptionist where fullName='$name' and email='$email'");
...
<html lang="en">
<head>
<title>Receptionist Password Recovery</title>
<meta charset="utf-8" />
...
<a href="../index.php"><h2> OCRAS | Receptionist Password Recovery</h2></a>
</div>
...
<fieldset>
<legend>
Receptionist Password Recovery
</legend>
<p>
