...
$sql=mysqli_query($con,"Update receptionist set fullName='$fname',address='$address',city='$city',gender='$gender' where id='".$_SESSION['id']."'");
if($sql)
{
...
<html lang="en">
<head>
<title>Receptionist | Edit Profile</title>
<meta charset="utf-8" />
...
<h1 class="mainTitle">Receptionist | Edit Profile</h1>
</div>
<ol class="breadcrumb">
<li>
...
<?php
$sql=mysqli_query($con,"select * from receptionist where id='".$_SESSION['id']."'");
