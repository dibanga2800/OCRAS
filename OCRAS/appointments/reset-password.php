...
$query=mysqli_query($con,"update receptionist set password='$newpassword' where fullName='$name' and email='$email'");
if ($query) {
...
<a href="../index.php"><h2> OCRAS | Receptionist Reset Password</h2></a>
</div>
