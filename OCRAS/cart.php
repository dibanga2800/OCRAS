  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <input type="hidden" name="description" value="<?=$item_count.' item'.(($item_count>1)?'s':'').' from Dibanga Opticians.';?> ">
       <input type="hidden" name="tax" value="<?=$tax;?>">
          ...
          <div id="step1" style="display:block;">
            ...
            <div class="form-group col-md-6">
              ...
              <input class="form-control" id="county" name="county" type="text" data-stripe="state">
            </div>
            <div class="form-group col-md-6">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary pull-right" onclick="check_address();" id="next_button">Next >></button>
...
jQuery.ajax({
  url : '/OCRAS/admin/parsers/check_address.php',
  method : 'POST',
  data : data,
