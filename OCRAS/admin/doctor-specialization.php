...
{
$sql=mysqli_query($con,"insert into doctorspecialization(specialization) values('".$_POST['doctorspecialization']."')");
$_SESSION['msg']="Doctor Specialization added successfully !!";
}

if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from doctorspecialization where id = '".$_GET['id']."'");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Doctor Specialization</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
							...
							<input type="text" name="doctorspecialization" class="form-control"  placeholder="Enter Doctor Specialization">
								...
								<div class="col-md-12">
									...
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
<?php
$sql=mysqli_query($con,"select * from doctorspecialization");
$cnt=1;
