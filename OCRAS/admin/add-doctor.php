...
$sql=mysqli_query($con,"insert into doctors(specialization,doctorName,address,contactno,docEmail,password) values('$docspecialization','$docname','$docaddress','$doccontactno','$docemail','$password')");
if($sql)
{
