				...
				<li>
								...
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Receptionist </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
									...
									<li>
										<a href="add-receptionist.php">
											<span class="title"> Add Receptionist </span>
										</a>
									</li>
									<li>
										<a href="manage-receptionist.php">
											<span class="title"> Manage Receptionist </span>
										</a>
									</li>
