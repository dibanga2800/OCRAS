...
if(isset($_GET['del']))
{
mysqli_query($con,"delete from receptionist where id = '".$_GET['id']."'");
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Admin | Manage Receptionist</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Admin</span>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">Manage <span class="text-bold">Receptionist</span></h5>
...
<a href= "edit-receptionist.php?id=<?php echo $row['id'];?>" class="btn btn-transparent btn-xs" tooltip-placement="top" tooltip="Edit"><i class="fa fa-pencil"></i></a>
