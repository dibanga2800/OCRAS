...
$sql=mysqli_query($con,"Update doctors set specialization='$docspecialization',doctorName='$docname',address='$docaddress',contactno='$doccontactno',docEmail='$docemail' where id='$did'");
if($sql)
{
