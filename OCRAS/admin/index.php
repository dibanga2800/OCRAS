...
<h3 class="StepTitle">Manage Patients</h3>
...
<h3 class="StepTitle">Manage Doctors</h3>
...
<h3 class="StepTitle"> Appointments</h3>

<p class="links cl-effect-1">
<a href="book-appointment.php">
<a href="appointment-history.php">
<?php $sql3= mysqli_query($con,"SELECT * FROM appointment");
