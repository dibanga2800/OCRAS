...
<h3 class="text-center">Shipping Adress</h3>
<address>
<?=$txn['full_name'];?><br>
<?=$txn['street'];?><br>
...
<a href="stockmgt.php" class="btn btn-large btn-default">Cancel</a>
<a href="orders.php?complete=1&cart_id=<?=$cart_id;?>" class="btn btn-success btn-large">Complete Order</a>
</div>
