...
$query=mysqli_query($con,"insert into receptionist(fullname,address,city,gender,email,password) values('$fname','$address','$city','$gender','$email','$password')");
if($query)
{
...
<a href="../index.php"><h2>OCRAS | Receptionist Registration</h2></a>
</div>
